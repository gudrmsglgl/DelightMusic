...
include(":core:feature:musiclist")
include(":core:player")
include(":core:player:player")
include(":core:player:player-api")
include(":core:feature:musicdetail")
include(":core:router")
include(":core:router:router")
include(":core:feature:musiclist-api")
include(":core:router:router-api")
include(":core:feature:musicdetail-api")
